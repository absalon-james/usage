...
def _row_cost(row, costs, quantity):
    ...
    try:
        ...
        logger.exception(
            'Unable to find rate for Oracle Edition: {} Version:{}'
...
class CountLicenser(BaseCountLicenser):
    """
    Licenser that counts instances of Oracle usage by edition and version.
    """
    def __init__(self,
        ...
        if costs is None:
            costs = {}
        self._costs = costs
        self._title = 'Oracle Licensing Count'
...
class HourLicenser(BaseHourLicenser):
    """Licenser that counts hours of oracle usage."""
    def __init__(self,
                 project_id_field=None,
                 hours_field=None,
                 costs=None):
        ...
        if costs is None:
            costs = {}
        self._costs = costs
        self._title = 'Oracle Licensing by the hour'
